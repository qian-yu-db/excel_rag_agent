...
# MAGIC
# MAGIC * Ingestion PDF Document with Autoloader and Spark Structured Streaming
# MAGIC   * Using OSS [Unstructured API](https://docs.unstructured.io/open-source/introduction/overview) for PDF Ingestion with OCR
...
dbutils.widgets.text("volume", "pdfs")
dbutils.widgets.text("checkpoints_vol", "checkpoints")
dbutils.widgets.text("table_prefix", "excel_pdf")
...
# MAGIC %md
# MAGIC ## Bronze: Ingsetion PDF file as binary using Autoloader
